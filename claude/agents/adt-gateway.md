...
- **`mcp__sap-gui__*` — OPSİYONEL + SALT-OKUMA.** Allowlist'inde klasik Dynpro/ALV **okuma**
  ...
  `core/governance/tooling-plugins.md`). ⛔ Yazma yönü (tıklama/yazma/işlem çalıştırma) allowlist'te
