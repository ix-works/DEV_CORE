...
## 1. PULL-BEFORE-EDIT (ADR 0016 revize) — SAP KAYNAĞINDA ÇALIŞMAYA BAŞLARKEN, ANALİZDEN ÖNCE (lider DAHİL)
...
## 2. REVIEWER PRE-FLIGHT (ADR 0006) — SAP'YE YAZMADAN ÖNCE (ZORUNLU)
...
## 4. SAP ADT İŞLEM SIRASI (özet — detay [`playbook/`](playbook/))
...
## 7. OBJE→KLASÖR YERLEŞİMİ (somut; AGENTS §4'ten)
...
## 10. KULLANICIDAN TEYİT TABLOSU (AGENTS.md'den taşındı — D1 2026-08-01)
| Konu | Kural |
|---|---|
