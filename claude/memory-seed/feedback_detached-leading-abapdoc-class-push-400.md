...
**Bağlı yorumlar SORUNSUZ:** bir bildirimin HEMEN ÜSTÜ + method-İÇİ inline + statement-yanı. **Yetim (ölçülmüş konumlar):** `CLASS…IMPLEMENTATION.`↔ilk METHOD arası, ENDMETHOD↔METHOD arası, ENDCLASS sonrası. ⛔ **METHODS↔METHODS (DEFINITION bölümü) yetim DEĞİLDİR** — 2026-07-31 ölçümü: DEFINITION'da 73 satırlık kesintisiz yorum bandı bırakıldı, PUT **200**; metot GÖVDESİ içi yorum da (TRY. öncesi dahil) **200**. **En sık sebep:** bir metodu/alanı silip YORUMUNU bırakmak → yorum yetim kalır.
