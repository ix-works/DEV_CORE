...
- ⭐ [Sayfa kapanirken senkron xhr gitmez](feedback_sayfa-kapanirken-senkron-xhr-gitmez.md) — beforeunload/pagehide içindeki SENKRON XHR Chromium'da sunucuya hiç gitmez — kilit bırakma için fetch+keepalive+CSRF; bırakmadan sonra kilit bayrağını sıfırla
