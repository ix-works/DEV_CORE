...
| **U1 JIT-recall enjeksiyonu** | mcp-sap-docs (FTS5+BM25 offline kanıtı) + claude-mem index-deseni + resmî hooks additionalContext | UserPromptSubmit/spawn'da memory+lessons+playbook'tan top-K ders-İNDEKSİ (tam metin değil); ajan-farkında (agent_id) | hedef: `scripts/hooks/` yeni recall-hook + indeks-builder | ⏳ **ADAY (radar 2026-08-01; en-değerli-1)** — nudge-only başlar; Türkçe-BM25 zayıflığı+#49063 canlı doğrulanır |
