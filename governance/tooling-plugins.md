...
| npx sürüm-pin + credential-scan | secondsky/sap-dependency-security hook'u | pin'siz `npx/uvx @latest` MCP koşumuna RED/uyarı + config credential-literal taraması | hedef: `pre_tool_guard` | ⏳ ADAY (radar 2026-07-08) |
...
| ui5lint FE-gate | secondsky/sapui5-linter | resmi `@ui5/linter` FE reviewer zincirine WARNING-validator (abaplint'in FE simetriği) | — | ⚪ İZLE (deneme adayı) |
