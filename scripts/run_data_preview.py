...
Usage:
    python run_data_preview.py --object-name ZSD000_T_CONFIG --max-rows 50 --cwd /path/to/project
    python run_data_preview.py --object-name ZSD000_T_HISTORY --max-rows 5 --format json --cwd /path/to/project
    python run_data_preview.py --object-name ZSD000_T_HISTORY --max-rows 5 --where "MODEL = 'gpt-4'" --cwd /path/to/project
"""
import argparse
import csv
import json
...
def main():
    ...
    parser.add_argument('--object-name', required=True,
                       help='Table, view, or CDS entity name (e.g., ZSD000_T_CONFIG)')
