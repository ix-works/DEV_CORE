...
Usage:
    python create_table_type.py --name ZSD000_TT_CUSTOMERS --row-type ZSD000_S_CUSTOMER --description "Table of customers" --package ZSD000 --transport TRXXXXX --cwd /path/to/project
"""
import argparse
import sys
...
def main():
    ...
    parser.add_argument('--name', required=True,
                       help='Table type name (e.g., ZSD000_TT_CUSTOMERS)')
    parser.add_argument('--row-type', required=True,
                       help='Row type - data element, structure, or predefined type (e.g., ZSD000_E_TEST_ID, ZSD000_S_CUSTOMER)')
